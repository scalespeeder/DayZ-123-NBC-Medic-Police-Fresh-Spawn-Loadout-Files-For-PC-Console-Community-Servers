...
Upload "police-loadout.json" and / or "nbc-medic-loadout.json" from the extracted files to inside the "custom" folder of the mission directory on your server.
...
EG:
        ...
        "spawnGearPresetFiles": ["custom/police-loadout.json","custom/nbc-medic-loadout.json"],
        "StaminaData":
...
Edit it to look like this: 
	...
	"spawnGearPresetFiles": ["custom/police-loadout.json"],
	
	OR
	
	"spawnGearPresetFiles": ["custom/custom/nbc-medic-loadout.json"],
